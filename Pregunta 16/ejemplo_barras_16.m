...
%Set Y label
title('(16) ¿Considera que el trabajo colaborativo mejora la interacción y relación entre sus compañeros?');
% Set Z label
...
yticklabels = {'Totalmente de acuerdo (22)', 'De acuerdo (23)', 'Ni en desacuerdo ni de acuerdo (6)', 'En desacuerdo (1)', 'Totalmente en desacuerdo (3)'};
